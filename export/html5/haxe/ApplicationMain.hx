...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("nointernet", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("nointernet", null, 1400, 880);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "44";
		app.meta["company"] = "";
		app.meta["file"] = "nointernet";
		app.meta["name"] = "no_internet";
	...
	macro public static function getPreloader()
	{
		...
		var type = Context.getType("layout.SaltPreloader");
		...
		return macro
		{
			new openfl.display.Preloader(new layout.SaltPreloader());
		}
