...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_locales_fr_fr_wifi_lan_txt extends null { }
...
@:keep @:file("assets/locales/fr-FR/wifi-lan.txt") @:noCompletion #if display private #end class __ASSET__assets_locales_fr_fr_wifi_lan_txt extends haxe.io.Bytes {}
